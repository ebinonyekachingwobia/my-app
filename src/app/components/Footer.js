    ...
    <div className='container mx-auto mb-24'>
      ...
      <motion.div 
        ...
        <div className='flex flex-col flex-1 gap-y-8'>
          ...
          {/* text */}
          <div className='text-secondary'>Ut consequat elit velit sint excepteur incididunt dolor eu officia.</div>
          {/* phone and email */}
        ...
        {/* newsletter */}
          <div>
            ...
            <div className='mb-9 text-secondary'>loremAliqua aute dolor dolor esse mollit sint.</div>
            {/* form */}
            <form className='flex gap-x-2 h-14'>
              <input 
              type="text" 
              placeholder="Your email"
              className='outline-none bg-white h-full border rounded-half pl-4 focus:border-accent'
              />

              <button type="submit" className='btn btn-sm btn-accent w-24 rounded-lg' >Submit</button>
