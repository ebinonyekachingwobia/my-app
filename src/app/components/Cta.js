  ...
  <section  
    ...
    <div className='container mx-auto'>
      ...
      <div className='flex-1 xl:ml-24 text-center md:text-left mb-12 md:mb-0'>
        ...
        className='mb-10'
        >
          Consequat adipisicing ipsum occaecat officia labore consequat elit amet anim incididunt elit elit labore. Dolore fugiat fugiat tempor velit tempor dolore officia adipisicing nostrud sunt sunt tempor
        </motion.p>
        {/* btn */}
        <motion.div 
