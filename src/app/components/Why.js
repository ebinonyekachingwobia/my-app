...
export default function Why() {
  ...
  <section className="section flex items-center bg-green-200" id="why">
    <div className='container mx-auto'>
      ...
      >
        Our dedication to providing exceptional services sets us apart from the competition. From the moment you engage with us, we strive to exceed our expectations in the every interaction.
      </motion.p>
      {/* car image */}
      <motion.div 
